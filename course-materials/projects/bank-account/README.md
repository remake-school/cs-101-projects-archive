...
1. Then define the following methods for the `BankAccount` class:
	...
	- The `print_receipt` method prints a receipt with the account name, account number, and balance like this:
		...
		Balance: $100.00
		~~~
1. Outside of the BankAccount class, define 3 different bank account examples using the `BankAccount()` object.
